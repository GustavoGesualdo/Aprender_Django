...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware',   # ← Adicione esta linha (logo após SecurityMiddleware)
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'templates/static')]  # mantenha se você usa assim
